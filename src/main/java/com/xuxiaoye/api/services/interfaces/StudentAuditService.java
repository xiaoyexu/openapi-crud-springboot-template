...
public interface StudentAuditService extends Service<String, StudentAudit, SearchStudentAuditRequest, PagedStudentAudits, StudentAuditMapper, StudentAuditDBService> {
}